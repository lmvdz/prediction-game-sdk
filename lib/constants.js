...
const LOCALNET_PROGRAM_ID = new web3_js_1.PublicKey("BW6JsuUYGwRoqpvGXPaGoekxUZgmoR6vcqeNAguHLYZv");
const MAINNET_PROGRAM_ID = new web3_js_1.PublicKey("BW6JsuUYGwRoqpvGXPaGoekxUZgmoR6vcqeNAguHLYZv");
const DEVNET_PROGRAM_ID = new web3_js_1.PublicKey("BW6JsuUYGwRoqpvGXPaGoekxUZgmoR6vcqeNAguHLYZv");
const TESTNET_PROGRAM_ID = new web3_js_1.PublicKey("BW6JsuUYGwRoqpvGXPaGoekxUZgmoR6vcqeNAguHLYZv");
